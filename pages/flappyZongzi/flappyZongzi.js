// pages/flappyZongzi/flappyZongzi.js
var ctx = null;
var res = null;
var bird={   // bird对象
    y:100,   // bird初始左上角y坐标
...
var bnum = 0;  // 完成个数
var zongzi = '../../images/zongzi.png';
Page({
  data:{
    canvas_fb_style:'',
    style_start:'',
    src_img_title:'../../images/titleFlappyZongzi.png',
    bird_number:0
  },
  ...
  birdDown:function(){
    ...
    this.pipe()
    ctx.drawImage(zongzi, bird.x, bird.y, bird.px, bird.px)

    ctx.draw()

    timer1 = setTimeout(this.birdDown, 16)
  ...
  // 随机空隙的管道
  pipe:function(){
      ctx.drawImage('../../images/dragonBoatDown.png', pipe.x, 0, pipe.width, gapHeightY)
      ctx.drawImage('../../images/dragonBoatUp.png', pipe.x, gapHeightY+gapHeight, pipe.width, res.windowHeight-gapHeightY-gapHeight)
  },
  ...
  gameOver:function(){
      this.setData({
        ...
        src_img_title:'../../images/text_game_over.png'
      })
  } ,
